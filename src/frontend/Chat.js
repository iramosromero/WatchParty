...
class Chat extends Component {
  ...
  handleButtonPress() {
    ...
    authFetch('/chat/global', 'POST', { msg: chatText, sentBy: localUsername, sentAt: new Date() })
      .then((data) => {
    ...
    return (
      <Grommet>
        ...
        >
          ...
          <Box style={{ background: 'linear-gradient(90deg, #567572FF 0%, #964F4CFF 100%)' }} gridArea="footer" direction="row">
